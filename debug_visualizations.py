...
class DebugEnrollmentVisualizer:
    ...
    def prepare_data_for_analysis(self, df):
        ...
        print(f"Preparing data for analysis. Shape: {df.shape}")
        print(f"Columns: {df.columns.tolist()}")
    ...
    def create_confusion_matrix_and_roc(self, X, y):
        ...
        print(f"Valid data for classification: {len(y_valid)} samples")
        print(f"Target distribution: {y_valid.value_counts()}")
    ...
    def run_visualization_analysis(self, batch_size=5):
        ...
        print("Debug Enrollment Data Visualization Analysis")
        print("=" * 60)
        ...
        print(f"Final dataframe shape: {self.processed_data.shape}")
        print(f"Final columns: {self.processed_data.columns.tolist()}")
        ...
        if 'dropout_indicator' in self.processed_data.columns:
            ...
            print("Available columns:", self.processed_data.columns.tolist())
...
def main():
    ...
    visualizer = DebugEnrollmentVisualizer(workspace_dir)
