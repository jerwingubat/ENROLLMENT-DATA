...
class CSVBatchEnrollmentVisualizer:
    ...
    def extract_enrollment_data_from_csv(self, file_path):
        """Extract enrollment data from CSV file"""
        ...
        try:
            ...
            if program_col is None:
                print(f"  No program column found in {file_path}")
                return []
            ...
            if df_clean.shape[0] > 0:
                ...
                program_data = self.process_enrollment_sheet(df_clean, program_col)
    ...
    def process_enrollment_sheet(self, df, program_col):
        ...
        for i in range(0, len(csv_files), batch_size):
            ...
            for csv_file in batch:
                try:
                    ...
                    # Extract enrollment data from CSV
                    program_data = self.extract_enrollment_data_from_csv(csv_file)
    ...
    def run_csv_batch_visualization_analysis(self, batch_size=5):
        """Run the complete CSV batch visualization analysis"""
        print("CSV Batch Enrollment Data Visualization Analysis")
        print("=" * 60)
        ...
        print("\nAll CSV batch visualizations completed and saved!")
...
def main():
    ...
    visualizer = CSVBatchEnrollmentVisualizer(workspace_dir)
    
    # Run CSV batch visualization analysis
    visualizer.run_csv_batch_visualization_analysis(batch_size=5)
